...
In mathematics, *formal* reasoning involves symbolic manipulations that follow established rules without delving into deeper, rigorous definitions. For instance, treating $dx$ as if it were a fraction or "canceling" terms may not be strictly defined but is consistent with the final, rigorous result.
